...
export default function BottomNav({
    ...
    return (
        <nav
            className="fixed bottom-0 left-0 right-0 z-50 bg-background-dark/85 backdrop-blur-md border-t border-white/10 px-6 py-3 flex justify-between items-center pb-10 text-xl">
